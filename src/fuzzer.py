...
def main():
    ...
    while True:
        ...
        # Create and initialize a TestScenario instance based on the metadata read from the popped seed file.

        test_scenario = fuzz_utils.TestScenario(conf, base=scenario)
        successor_scenario = None

        # STEP 3: SCENE MUTATION
        # While test scenario has quota left, mutate scene by randomly generating walker/vehicle/puddle.
