...
of the files and a predefined set of rules (crash diavio_DSL). The responses are then saved in a specified directory. It includes
...
# Read the crash diavio_DSL syntax and content
    ...
    def get_chat_response():
        response = openai.ChatCompletion.create(
            ...
            messages=[
                ...
                {"role": "user", "content": "Case summary:" + case_summary + "Crash diavio_DSL:" + crash_dsl +
                    """Find out an answer in the content of the Crash diavio_DSL with the closest meaning to your answer. If there is no matching answer, keep your original answer."""},
            ],
            temperature=0.5,
            max_tokens=2048
        )
